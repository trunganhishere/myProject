...
<form class="shadow-lg p-3 mb-5 bg-body-tertiary rounded col-7" style="margin-top: 12%; margin-left: 23%"
    ...
    <div class="position-relative mt-5">
        <button class="btn btn-primary position-absolute top-100 start-50 translate-middle col-5"
                onclick="return checkNull()">Sign in
        </button>

    </div>
    <br>
    <label style="color: red" class="mt-2" id="errorMessage">${error}</label>
    <p class="text-end mt-3"><a href="/sign-up">Create account ?</a>
    <p>
        <br>
</form>
